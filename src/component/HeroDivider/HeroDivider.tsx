const HeroDivider = () => {
  return (
    <>
      <div className="bg-purple-primary flex flex-col md:flex-row justify-between  items-center px-20 py-10 gap-8 md:px-36 md:py-10">
        <div className="flex flex-col justify-center items-center gap-4">
          <p className={"text-5xl text-white font-bold"}>10K+</p>
          <p
            className={
              "flex text-sm text-center text-purple-secondary items-center justify-center"
            }
          >
        ...
        <div className="flex flex-col justify-center items-center gap-4">
          ...
          <p className={"text-sm text-center text-purple-secondary"}>
