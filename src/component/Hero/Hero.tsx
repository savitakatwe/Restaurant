      ...
      <div className="flex flex-col md:flex-row justify-center md:justify-between h-fit  items-center mt-28">
        <div className="w-3/4 md:w-1/2 m-5 md:m-12 justify-center">
          ...
          <p className="text-dark-tertiary text-center md:text-left text-lg my-5">
            EatLy helps you set saving goals, earn cash back offers, go
            <br /> to the disclaimer for more details, and get paychecks up to
            two
            <br /> days early. Get a $20 bonus.
          </p>
          <div className={"flex gap-4 justify-center md:justify-start"}>
            <button className="p-3  bg-purple-primary border-solid border rounded-2xl text-white text-base	">
              Get Started
            </button>
            <button className="p-3  bg-white border-solid border border-purple-primary rounded-2xl text-purple-primary text-base	">
              Go Pro
            </button>
          </div>
